...
Note that if participants were enrolled in more than cohort (crossover), the total N for Full Sample would be less than that of the total N of the adverse event first attribution categories. Since total N for Full Sample (38) is the same as total N of the severity categories (12 + 3 + 12 + 11), this suggests that there was no crossover of participants in cohorts.
...
rm_covsum_nested(data = clinT, id = c("Subject", "COHORT"), 
...
rm_covsum_nested(data = clinT, id = c("Subject", "COHORT"), 
  covs = c("AE_SEV_GD", "ENROL_DATE_INT", "COHORT", "GENDER_CODE", "INELIGIBILITY_STATUS", "AE_ONSET_DT_INT", "Drug_2_Attribution"), maincov = "Drug_1_Attribution", full=F);
```
...
#### Example 1
Uses addendum fake study data. Shows timeline for onset of related AE after study enrollment. Can display up to 5 attributions. Time unit may be one of day, week, month or year.
