...
Uses addendum fake study data. Shows timeline for onset of AE after study enrollment. The first plot includes both AE category and AE detail.
...
The below plot summarizes timeline by AE category.
