...
You can install the main version of BiostatsUHNplus from [GitHub](https://github.com/) with:
...
You can install the development version (option to include effect size in nested summaries) of BiostatsUHNplus from [GitHub](https://github.com/) with:
