...
If version 0.1.0 or higher of **reportRmd** is installed, you can install **BiostatsUHNplus** from [GitHub](https://github.com/) with:
...
Uses addendum simulated study data. DSMB-CCRU AE summary tables in below code example can be found in the *dsmb_ccru_tables* folder of **BiostatsUHNplus** package.
