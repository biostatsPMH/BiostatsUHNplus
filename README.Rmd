...
### Wrapper functions for MCMCglmm object with binary outcome

#### Nice table of model summary output for fixed effects
...
#### Nice table of intraclass correlation coefficients
