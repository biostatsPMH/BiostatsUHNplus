...
ggsave(paste("images/variance_pie_plot", ".png", sep=""), p, width=6.4, height=4.0, device="png");
...
knitr::include_graphics(paste("images/variance_pie_plot", ".png", sep=""))
```
...
ggsave(paste("images/caterpillar_plot_Cows_", "Model.png", sep=""), pRE_Cows, scale = 1.1, width=6.4, height=7.4, device="png");
...
ggsave(paste("images/caterpillar_plot_Yards_", "Model.png", sep=""), pRE_Yards, scale = 1.1, width=6.4, height=3.2, device="png");
```
...
knitr::include_graphics(paste("images/caterpillar_plot_Cows_", "Model.png", sep=""))
```
...
knitr::include_graphics(paste("images/caterpillar_plot_Yards_", "Model.png", sep=""))
```
