...
caterpillar_plot <- function(subjID,subjLabel=NULL,
  ...
  pPlot <- 
    ...
    theme(strip.text = element_blank(), plot.margin=unit(c(0,1,0,1),"lines"), axis.ticks.length = unit(0.5, "lines"), axis.ticks=element_blank(), panel.margin.y = unit(1, "lines"), axis.ticks.y=element_blank()) +
