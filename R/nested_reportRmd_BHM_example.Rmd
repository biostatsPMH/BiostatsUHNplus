...
author:
  #- Tyler Pittman:
  #    email: tyler.pittman@uhnresearch.ca
      #institute: biostats
      #correspondence: true
  #- name: Amy Liu
  #  institute: [biostats, dalla]
  #- name: Wei Xu
  #  institute: [biostats, dalla]
institute:
  - biostats: Department of Biostatistics, Princess Margaret Cancer Centre, Toronto, Canada
  #- dalla: Dalla Lana School of Public Health, University of Toronto, Toronto, Canada
date: "`r format(Sys.time(), '%d %B %Y')`"
output: 
  word_document:
    toc: yes
    pandoc_args: 
      - !expr paste0("--lua-filter=", here::here("T:/Knowledge Transfer Rounds/KTR 2023/Tyler_covsum_nested_BHM/lua_filters", "scholarly-metadata.lua"))
      - !expr paste0("--lua-filter=", here::here("T:/Knowledge Transfer Rounds/KTR 2023/Tyler_covsum_nested_BHM/lua_filters", "author-info-blocks.lua"))
...
#---#Below is how to run RMarkdown script in Windows Commmand prompt for batch jobs!
### make sure you have Pandoc installed under your own account (you can do this yourself) https://pandoc.org/installing.html

### this starts CMD job in background so after closing CMD prompt it still executes
# @start "" C:\"Program Files"\R\R-4.2.2\bin\Rscript.exe -e "rmarkdown::render('T:\\Knowledge Transfer Rounds\\KTR 2023\\Tyler_covsum_nested_BHM\\nested_reportRmd_BHM_example_18Jan2023.Rmd')"
#---#
...
setwd("T:\\Knowledge Transfer Rounds\\KTR 2023\\Tyler_covsum_nested_BHM");
...
\newpage
# Background {-}
This is a demonstration of how to use the **reportRmd** package for example data with *rm_covsum()* and R Markdown. A nested version of function, *rm_nested_covsum()* is demonstrated.
...
```{r funcs, echo=F, warning=F, message=F, results='asis'}
source("covsum_nested_28Dec2022.R")
source("nice_mcmcglmm_28Dec2022.R")
...
ggsave(paste("variance_pie_plot", ".png", sep=""), p, width=6.4, height=4.0, device="png");
...
knitr::include_graphics(paste("variance_pie_plot", ".png", sep=""))
```
...
ggsave(paste("caterpillar_plot_Cows_", "Model.png", sep=""), pRE_Cows, scale = 1.1, width=6.4, height=7.4, device="png");
...
ggsave(paste("caterpillar_plot_Yards_", "Model.png", sep=""), pRE_Yards, scale = 1.1, width=6.4, height=3.2, device="png");
```
...
knitr::include_graphics(paste("caterpillar_plot_Cows_", "Model.png", sep=""))
```
...
knitr::include_graphics(paste("caterpillar_plot_Yards_", "Model.png", sep=""))
```
